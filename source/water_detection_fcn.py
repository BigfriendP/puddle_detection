...
def inference(image, keep_prob):
    ...
    ra_1, ra_1_small = utils.RA_unit(relu1_2, relu1_2.shape[1], relu1_2.shape[2], 16)
    ...
    ra_2, ra_2_small = utils.RA_unit(relu2_2, relu2_2.shape[1], relu2_2.shape[2], 16)
    ...
    ra_3, ra_3_small = utils.RA_unit(relu3_3, relu3_3.shape[1], relu3_3.shape[2], 16)
    ...
    ra_4, ra_4_small = utils.RA_unit(relu4_3, relu4_3.shape[1], relu4_3.shape[2], 16)
    ...
    ra_5, ra_5_small = utils.RA_unit(relu5_3, relu5_3.shape[1], relu5_3.shape[2], 8)
    ...
    W6 = utils.weight_variable([7, 7, pool4.shape[3], 4096], name="W6")
    ...
    W_t2 = utils.weight_variable([4, 4, deconv_shape2[3], deconv_shape1[3]], name="W_t2")
    ...
    W_t3 = utils.weight_variable([16, 16, NUM_OF_CLASSESS, fuse_2.shape[3]], name="W_t3")
